...
import jwt.security.AuthoritiesConstants;
...
public class AccountResourceIT {
    ...
    public void setup() {
        ...
        AccountResource accountResource =
            new AccountResource(userRepository, userService, mockMailService, tokenProvider, passwordVerification);

        AccountResource accountUserMockResource =
            new AccountResource(userRepository, mockUserService, mockMailService, tokenProvider, passwordVerification);
