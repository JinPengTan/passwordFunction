...
import jwt.config.audit.AuditEventConverter;
import jwt.domain.PersistentAuditEvent;
...
import static jwt.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
