...
import { ApiKeyDeleteDialogComponent } from 'app/entities/api-key/api-key-delete-dialog.component';
import { ApiKeyService } from 'app/entities/api-key/api-key.service';

describe('Component Tests', () => {
  describe('ApiKey Management Delete Component', () => {
    let comp: ApiKeyDeleteDialogComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ApiKeyDeleteDialogComponent, '')
        .compileComponents();
