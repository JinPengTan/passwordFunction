...
import { TokenHistoryDeleteDialogComponent } from 'app/entities/token-history/token-history-delete-dialog.component';
  ...
  describe('TokenHistory Management Delete Component', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [TokenHistoryDeleteDialogComponent]
      })
