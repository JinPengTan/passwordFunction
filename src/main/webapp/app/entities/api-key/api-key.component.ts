...
export class ApiKeyComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    this.apiKeyService
      ...
      .subscribe(
        (res: HttpResponse<IApiKey[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
        () => this.onError()
      );
  }
  ...
  registerChangeInApiKeys(): void {
    this.eventSubscriber = this.eventManager.subscribe('apiKeyListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IApiKey[] | null, headers: HttpHeaders, page: number): void {
