...
import { TokenHistoryComponent } from 'app/entities/token-history/token-history.component';
...
describe('Component Tests', () => {
  describe('TokenHistory Management Component', () => {
    let comp: TokenHistoryComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(TokenHistoryComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.tokenHistories && comp.tokenHistories[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
